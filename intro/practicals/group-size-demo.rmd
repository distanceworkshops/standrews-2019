...
author: "Addressing size bias through covariate in detection function"
date: "`r Sys.Date()`"
...
```{r fig-nocap-margin-first, fig.margin=TRUE, fig.width=4, fig.height=4, echo=FALSE}
...
```{r sim10, cache=TRUE, echo=FALSE, fig.margin=TRUE, message=FALSE, warning=FALSE}
set.seed(2462)
...
```{r nocov-10, echo=FALSE, fig.margin=TRUE, message=FALSE}
