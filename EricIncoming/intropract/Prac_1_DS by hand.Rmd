...
date: Exercise 1. Line transect detection functions by hand
output: 
  pdf_document:
...
```{r, echo=FALSE}
# Generate summary table for printing
nests.sum <- NULL
...
# Print table
pander::pander(nests.sum, caption="Frequency of duck nests detected in perpendicular distance bands (metres)")
```
...
```{r, echo=FALSE}
# Read in data
nests <- read.csv(file="data/IntroDS_1.1.csv", header=T)
